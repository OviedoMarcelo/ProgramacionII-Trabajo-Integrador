...
public class EnvioDAO implements GenericDAO<Envio> {
    ...
    private static final String INSERT_SQL =
            "INSERT INTO envios (tracking,empresa,tipo,costo,fechaDespacho,fechaEstimada,estado) "
            + "VALUES (?, ?,?,?,?,?,?)";

    /** Sentencia SQL para actualizar un envío existente. */
    private static final String UPDATE_SQL =
            "UPDATE envios SET tracking=?,empresa=?,tipo=?,costo=?,fechaDespacho=?,fechaEstimada=?,estado=? "
            + "WHERE id = ?";
